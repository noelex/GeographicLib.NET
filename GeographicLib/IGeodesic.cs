namespace GeographicLib
{
    ...
    /// </summary>
    public interface IGeodesic : IEllipsoid
    {
        #region General version of direct and inverse geodesic solution
        /// <summary>
        /// The general direct geodesic problem. <see cref="Direct(double, double, double, double, out double, out double)"/>
        /// and <see cref="ArcDirect(double, double, double, double, out double, out double, out double)"/> are defined in terms of this function.
        /// </summary>
        ...
        /// <see cref="Inverse(double, double, double, double, out double)"/> is defined in terms of this function.
        /// </summary>
        /// <param name="lat1">latitude of point 1 (degrees).</param>
        /// <param name="lon1">longitude of point 1 (degrees).</param>
        /// <param name="azi1">azimuth at point 1 (degrees).</param>
