...
namespace GeographicLib.SphericalHarmonics
{
    ...
    /// </remarks>
    public class SphericalHarmonic1
    {
        ...
        public SphericalHarmonic1(ReadOnlyMemory<double> C,
            ...
            : this(new SphericalEngine.Coeff(C, S, N), new SphericalEngine.Coeff(C1, S1, N1), a, norm)
            { }
        ...
        /// </remarks>
        public double Evaluate(double tau, double x, double y, double z)
        {
            Span<double> f = stackalloc double[] { 1, tau };
        ...
        /// <returns><i>V</i>, the spherical harmonic sum.</returns>
        /// <remarks>
        /// This is the same as <see cref="Evaluate(double, double, double, double)"/>,
        ...
        /// <summary>
        /// Create a <see cref="CircularEngine"/> to allow the efficient evaluation of several points on a circle of latitude at a fixed value of <i>tau</i>.
        /// </summary>
        /// <param name="tau">multiplier for correction coefficients <i>C</i> ' and <i>S</i> '.</param>
        ...
        /// <remarks>
        /// <see cref="Evaluate(double, double, double, double)"/> exchanges the order of the sums in the definition,
        /// i.e., ∑<i>n</i> = 0..<i>N</i> ∑<i>m</i> = 0..<i>n</i> becomes ∑<i>m</i> = 0..<i>N</i> ∑<i>n</i> = <i>m</i>..<i>N</i>.
        /// <see cref="Circle(double, double, double, bool)"/> performs the inner sum over degree n (which entails about <i>N</i>^2 operations).
        ...
        /// </remarks>
        public CircularEngine Circle(double tau, double p, double z, bool gradp)
        {
            Span<double> f = stackalloc double[] { 1, tau };
