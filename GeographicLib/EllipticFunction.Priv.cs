...
{
    partial class EllipticFunction
    {
        internal struct Priv
        {
            ...
            public double _k2, _kp2, _alpha2, _alphap2, _eps;
            public double _Kc, _Ec, _Dc, _Pic, _Gc, _Hc;
            ...
            public void Reset(double k2 = 0, double alpha2 = 0) => Reset(k2, alpha2, 1 - k2, 1 - alpha2);
