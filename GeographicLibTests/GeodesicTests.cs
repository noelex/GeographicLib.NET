...
namespace GeographicLib.Tests
{
    ...
    new object[]{-29.47124, 95.14681, -163.779130441688382,
     ...
     -0.51527225545373252, -0.51556587964721788, 104679964020340.318 }
        ...
        {
            var f = 1;
            var a12a = Geodesic.WGS84.GenInverse(lat1, lon1, lat2, lon2, GeodesicFlags.All,
        ...
        {
            var f = 1;
            var a12a = Geodesic.WGS84.GenDirect(lat1, lon1, azi1, false, s12, GeodesicFlags.All | GeodesicFlags.LongUnroll,
        ...
        {
            var f = 1;
            var a12a = Geodesic.WGS84.GenDirect(lat1, lon1, azi1, true, a12, GeodesicFlags.All | GeodesicFlags.LongUnroll,
                out var lat2a, out var lon2a, out var azi2a, out var s12a,
                out var m12a, out var M12a, out var M21a, out var S12a);
